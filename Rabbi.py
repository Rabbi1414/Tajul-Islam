...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mTAJUL')
...
os.system('espeak -a 300 " Welcome,   to,  TAJUL,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/TAJUL ISLAM RABBI.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
,--------. ,---.       ,--.,--. ,--.,--.    
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-TAJUL ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Tajul King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mTajul-King ]   ║\33[1;34m   
╠══[Whatsapp                 • Xxxxxxxxx ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[TAJUL-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Tutul-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•TAJUL-Cp] {idf} • {pw}')     
				...
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " TAJUL,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/TAJUL-King/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
